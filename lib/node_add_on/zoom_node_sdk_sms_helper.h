...
public:
	...
	static void SetNeedRealNameAuthMeetingNotificationCB_WithoutCountryList(const v8::FunctionCallbackInfo<v8::Value>& args);
...
static void InitClassAttribute<ZoomNodeSDKSMSHelperWrap >(const v8::Local<v8::FunctionTemplate>& tpl, v8::Isolate* isolate)
{
	...
	NODE_SET_PROTOTYPE_METHOD(tpl, "SetNeedRealNameAuthMeetingNotificationCB_WithoutCountryList", ZoomNodeSDKSMSHelperWrap::SetNeedRealNameAuthMeetingNotificationCB_WithoutCountryList);
